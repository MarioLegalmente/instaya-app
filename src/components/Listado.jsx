...
export default function Listado(){
    return(
        ...
        <h3 className="fw-bold text-center mt-5 text-uppercase p-3 col-sm-12 col-md-6 row justify-content-end">Listado de Órdenes</h3>
        <div className="row justify-content-center align-items-center"style={{height:"500px"}}>
            <div className="bg-light col-sm-12 col-md-6 border border-white">
                <Link href="/recoger" className="link-primary row justify-content-end m-0 p-3">Crear Órden</Link>
